        ...
        <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
            ...
            <header className="bg-white shadow-sm px-6 py-4 flex items-center justify-between sticky top-0 z-20">
                <div>
                    ...
                    <div>
                        <button className='cursor-pointer hover:text-blue-600 transition-colors' onClick={() => navigate("/")}>
                            <Home size={18} />
                        </button>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="cursor-pointer flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-red-600 transition-colors px-3 py-2 rounded-lg hover:bg-red-50 group"
                    title="Cerrar Sesión"
                >
